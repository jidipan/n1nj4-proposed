...
import "./DashboardLegacyPage.css";
...
const EVENT_STATUS_LABEL: Record<StadiumEventStatus, { zh: string; en: string; cls: string }> = {
  ...
  done: { zh: "已完成", en: "Done", cls: "ended" },
  ended: { zh: "已结束", en: "Ended", cls: "ended" },
};

/* 护照露出卡 · 与旧版护照页 (DashboardLegacyIdentityPage) 同源的真实子集:
  ...
  return (
    <div className="dash-page">
      <div className="dash-shell">
        <div className="dash-legacy-label">
          <strong>Dashboard Legacy</strong>
          <span>{t("旧版方案 · 仅供参考", "Previous concept · reference only")}</span>
        </div>
        {!isConnected && (
        ...
        <section className="dash-idbar">
          <Link to="/dashboard-legacy/identity" className="dash-idbar-left">
            <ImagePlaceholder
        ...
        <div className="dash-layout">
          ...
          <aside className="dash-rail">
            {/* 护照卡 · 对外可分享的身份摘要 (完整护照见 /dashboard-legacy/identity) */}
            <div className="dash-panel dash-namecard">
              ...
              <div className="dash-namecard-actions">
                <Link to="/dashboard-legacy/identity" className="dash-btn dash-btn-sm">{t("查看护照", "View passport")}</Link>
